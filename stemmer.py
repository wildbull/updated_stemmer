...
class PorterStemmer:
    ...
    def step2(self, word):
        if word.endswith('ational'):
            ...
            #word = self.replaceM0(word, 'fully', '')
    ...
    def stem(self, word):
        ...
        return word
test = PorterStemmer()
sentence="he worry successfully cry is a good boy and he is playing disrupting just had dinner and he cant eat again"
